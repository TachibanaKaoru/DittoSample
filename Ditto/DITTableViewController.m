...
#import "DITTableViewController.h"

#import "DITLabel.h"

@interface DITTableViewController ()

@end

@implementation DITTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    for( UIView* control in cellSubviews){
        ...
        if( [[[control class] description] isEqualToString:@"DITLabel"]){
            
            DITLabel* label = (DITLabel*)control;
